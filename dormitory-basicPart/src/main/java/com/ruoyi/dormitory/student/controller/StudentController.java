package com.ruoyi.dormitory.student.controller;
 ...
 */
@Controller
@RequestMapping("/dormitoryManager/student")
public class StudentController extends BaseController
{
    private String prefix = "dormitoryManager/student";

    @Autowired
    private IStudentService studentService;

    @RequiresPermissions("dormitoryManager:student:view")
    @GetMapping()
     ...
     * 查询学生信息列表
     */
    @RequiresPermissions("dormitoryManager:student:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出学生信息列表
     */
    @RequiresPermissions("dormitoryManager:student:export")
     ...
     * 新增保存学生信息
     */
    @RequiresPermissions("dormitoryManager:student:add")
     ...
     * 修改学生信息
     */
    @RequiresPermissions("dormitoryManager:student:edit")
     ...
     * 删除学生信息
     */
    @RequiresPermissions("dormitoryManager:student:remove")
